...
bot.action('seven', ctx => {
    ...
    <u>Дополнение №11</u>  <a href="media/Дополнение 11.word">Отправить  Дополнение №11</a>
    <u>Дополнение №12</u>  <a href="media/Дополнение 12 2019г.xlsx">Отправить  Дополнение №12</a>
    `;
